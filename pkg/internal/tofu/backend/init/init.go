...
import (
	...
	backendLocal "github.com/snyk/policy-engine/pkg/internal/tofu/backend/local"
	backendRemote "github.com/snyk/policy-engine/pkg/internal/tofu/backend/remote"
	backendAzure "github.com/snyk/policy-engine/pkg/internal/tofu/backend/remote-state/azure"
	backendConsul "github.com/snyk/policy-engine/pkg/internal/tofu/backend/remote-state/consul"
	backendCos "github.com/snyk/policy-engine/pkg/internal/tofu/backend/remote-state/cos"
	backendGCS "github.com/snyk/policy-engine/pkg/internal/tofu/backend/remote-state/gcs"
	backendHTTP "github.com/snyk/policy-engine/pkg/internal/tofu/backend/remote-state/http"
	backendInmem "github.com/snyk/policy-engine/pkg/internal/tofu/backend/remote-state/inmem"
	backendKubernetes "github.com/snyk/policy-engine/pkg/internal/tofu/backend/remote-state/kubernetes"
	backendOSS "github.com/snyk/policy-engine/pkg/internal/tofu/backend/remote-state/oss"
	backendPg "github.com/snyk/policy-engine/pkg/internal/tofu/backend/remote-state/pg"
	backendS3 "github.com/snyk/policy-engine/pkg/internal/tofu/backend/remote-state/s3"
	backendCloud "github.com/snyk/policy-engine/pkg/internal/tofu/cloud"
)
