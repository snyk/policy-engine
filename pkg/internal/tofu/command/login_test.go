...
import (
	...
	"github.com/snyk/policy-engine/pkg/internal/tofu/command/cliconfig"
	oauthserver "github.com/snyk/policy-engine/pkg/internal/tofu/command/testdata/login-oauth-server"
	tfeserver "github.com/snyk/policy-engine/pkg/internal/tofu/command/testdata/login-tfe-server"
	"github.com/snyk/policy-engine/pkg/internal/tofu/command/webbrowser"
