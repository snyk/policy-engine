...
import (
	...
	"github.com/snyk/policy-engine/pkg/internal/tofu/command/jsonformat/structured/attribute_path"
	...
	viewsjson "github.com/snyk/policy-engine/pkg/internal/tofu/command/views/json"
