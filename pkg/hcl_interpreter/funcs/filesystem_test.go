...
var testdataFsys = afero.FromIOFS{FS: testdata}
...
func TestFile(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(fmt.Sprintf("File(\".\", %#v)", test.Path), func(t *testing.T) {
			got, err := File(testdataFsys, ".", test.Path)
...
func TestTemplateFile(t *testing.T) {
	...
	templateFileFn := MakeTemplateFileFunc(testdataFsys, ".", func() map[string]function.Function {
		return map[string]function.Function{
			"join":         stdlib.JoinFunc,
			"templatefile": MakeFileFunc(testdataFsys, ".", false), // just a placeholder, since templatefile itself overrides this
		}
	})
...
func TestFileExists(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(fmt.Sprintf("FileExists(\".\", %#v)", test.Path), func(t *testing.T) {
			got, err := FileExists(testdataFsys, ".", test.Path)
...
func TestFileSet(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(fmt.Sprintf("FileSet(\".\", %#v, %#v)", test.Path, test.Pattern), func(t *testing.T) {
			got, err := FileSet(testdataFsys, ".", test.Path, test.Pattern)
...
func TestFileBase64(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(fmt.Sprintf("FileBase64(\".\", %#v)", test.Path), func(t *testing.T) {
			got, err := FileBase64(testdataFsys, ".", test.Path)
...
func TestPathExpand(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(fmt.Sprintf("Dirname(%#v)", test.Path), func(t *testing.T) {
			got, err := Pathexpand(afero.OsFs{}, test.Path)
